...
<a href="{{ route('admin.pesan-kontak.index') }}"
   class="{{ $linkBase }} {{ request()->routeIs('admin.pesan-kontak.*') ? $linkActive : $linkIdle }}"
   :class="desktopCollapsed ? 'justify-center' : ''"
   title="Pesan Hubungi Kami">
    ...
    <span x-show="!desktopCollapsed" x-transition class="whitespace-nowrap">Pesan Hubungi Kami</span>
</a>
