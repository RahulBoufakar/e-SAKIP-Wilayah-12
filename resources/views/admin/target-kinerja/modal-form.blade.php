<div x-show="modalOpen" x-cloak class="fixed inset-0 z-50 flex items-center justify-center px-4">
    ...
    >
        ...
        <div class="flex items-center justify-between border-b border-slate-100 px-6 py-4">
            <h3 class="text-base font-bold text-ink-900" x-text="mode === 'create' ? 'Tambah Sasaran Kegiatan' : 'Edit Sasaran Kegiatan'"></h3>
        ...
        <form
            method="POST"
            :action="mode === 'create' ? '{{ route('admin.target-kinerja.store') }}' : '{{ url('admin/target-kinerja') }}/' + form.id"
        ...
        >
            ...
            <div class="flex-1 space-y-3 overflow-y-auto px-6 py-4">
                <x-form.textarea
                    ...
                    :rows="3"
                    maxlength="255"
                    hint="Kode urut (mis. s.1) dibuat otomatis oleh sistem."
                    x-model="form.nama_sasaran"
                    required
                />
            </div>
