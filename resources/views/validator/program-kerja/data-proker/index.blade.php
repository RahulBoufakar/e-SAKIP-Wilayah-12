...
@section('content')
    <div class="flex w-full overflow-hidden rounded-t-2xl bg-white shadow-card">
        ...
        @if ($nextYearAvailable)
            <a href="{{ route('validator.data-proker.index', ['tahun' => 'h_plus_1']) }}"
               class="flex-1 border-b-2 px-4 py-3 text-center text-sm font-semibold transition-colors
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="py-1.5 text-left align-top">
                                                        <x-file-preview id="rab-pdf-{{ $row->id }}" label="File RAB (PDF)" :url="$row->file_rab_pdf"
                                                            :preview-url="route('validator.usulan-program-kerja.file.preview', [$row->id, 'rab-pdf'])"
                                                            :download-url="route('validator.usulan-program-kerja.file.unduh', [$row->id, 'rab-pdf'])"
                                                            :hide-label="true" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="py-1.5 text-left align-top">
                                                        @if ($row->file_rab_excel)
                                                            <a href="{{ route('validator.usulan-program-kerja.file.unduh', [$row->id, 'rab-excel']) }}" class="text-xs font-medium text-brand-700 hover:underline">Download</a>
