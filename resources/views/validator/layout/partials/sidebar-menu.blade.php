<a href="{{ route('validator.dashboard') }}"
   class="{{ $linkBase }} {{ request()->routeIs('validator.dashboard') ? $linkActive : $linkIdle }}"
...
<div x-data="{ open: {{ $isTargetKinerja ? 'true' : 'false' }} }">
    ...
    <div x-show="open" x-collapse class="mt-1 space-y-1">
        <a href="{{ route('validator.target-kinerja.index') }}"
           class="{{ $sublinkBase }} {{ request()->routeIs('validator.target-kinerja.*') ? $sublinkActive : $sublinkIdle }}"
        ...
        <a href="{{ route('validator.iku-lldikti.index') }}"
           class="{{ $sublinkBase }} {{ request()->routeIs('validator.iku-lldikti.*') ? $sublinkActive : $sublinkIdle }}"
           :class="desktopCollapsed ? 'justify-center !pl-3 !pr-3' : ''"
           title="IKU LLDIKTI">
        ...
        <a href="{{ route('validator.rencana-aksi.index') }}"
           class="{{ $sublinkBase }} {{ request()->routeIs('validator.rencana-aksi.*') ? $sublinkActive : $sublinkIdle }}"
           :class="desktopCollapsed ? 'justify-center !pl-3 !pr-3' : ''"
...
<div x-data="{ open: {{ $isProgramKerja ? 'true' : 'false' }} }">
    ...
    <div x-show="open" x-collapse class="mt-1 space-y-1">
        <a href="{{ route('validator.usulan-program-kerja.index') }}"
           class="{{ $sublinkBase }} {{ request()->routeIs('validator.usulan-program-kerja.*') ? $sublinkActive : $sublinkIdle }}"
           :class="desktopCollapsed ? 'justify-center !pl-3 !pr-3' : ''"
           title="Usulan Proker">
        ...
        <a href="{{ route('validator.data-proker.index', ['tahun' => 'berjalan']) }}"
           class="{{ $sublinkBase }} {{ request()->routeIs('validator.data-proker.*') ? $sublinkActive : $sublinkIdle }}"
           :class="desktopCollapsed ? 'justify-center !pl-3 !pr-3' : ''"
           title="Data Proker">
        ...
        <a href="{{ route('validator.kalender-proker.index', ['tahun' => 'berjalan']) }}"
           class="{{ $sublinkBase }} {{ request()->routeIs('validator.kalender-proker.*') ? $sublinkActive : $sublinkIdle }}"
           :class="desktopCollapsed ? 'justify-center !pl-3 !pr-3' : ''"
        ...
        <a href="{{ route('validator.pelaporan-kegiatan.index', ['tahun' => 'berjalan']) }}"
           class="{{ $sublinkBase }} {{ request()->routeIs('validator.pelaporan-kegiatan.*') ? $sublinkActive : $sublinkIdle }}"
           :class="desktopCollapsed ? 'justify-center !pl-3 !pr-3' : ''"
        ...
        <a href="{{ route('validator.pts-tagging.index') }}"
           class="{{ $sublinkBase }} {{ request()->routeIs('validator.pts-tagging.*') ? $sublinkActive : $sublinkIdle }}"
           :class="desktopCollapsed ? 'justify-center !pl-3 !pr-3' : ''"
           title="Tagging PTS">
            ...
            <span x-show="!desktopCollapsed" x-transition class="whitespace-nowrap">Tagging PTS</span>
        </a>
    </div>
</div>
...
<div x-data="{ open: {{ $isCapaianKinerja ? 'true' : 'false' }} }">
    ...
    <div x-show="open" x-collapse class="mt-1 space-y-1">
        <a href="{{ route('validator.capaian-kinerja.index') }}"
           class="{{ $sublinkBase }} {{ request()->routeIs('validator.capaian-kinerja.*') ? $sublinkActive : $sublinkIdle }}"
           :class="desktopCollapsed ? 'justify-center !pl-3 !pr-3' : ''"
           title="Capaian Kinerja">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75"><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" /></svg>
            <span x-show="!desktopCollapsed" x-transition class="whitespace-nowrap">Capaian Kinerja</span>
        </a>
        <a href="{{ route('validator.analisa-kinerja.index') }}"
           class="{{ $sublinkBase }} {{ request()->routeIs('validator.analisa-kinerja.*') ? $sublinkActive : $sublinkIdle }}"
           :class="desktopCollapsed ? 'justify-center !pl-3 !pr-3' : ''"
