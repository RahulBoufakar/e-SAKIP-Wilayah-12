...
<div x-data="{ open: {{ $isTargetKinerja ? 'true' : 'false' }} }">
    ...
    <div x-show="open" x-collapse class="mt-1 space-y-1">
        <a href="{{ route('validator.target-kinerja.index') }}" class="{{ $sublinkBase }} {{ request()->routeIs('validator.target-kinerja.*') ? $sublinkActive : $sublinkIdle }}">Target Kinerja</a>
        <a href="{{ route('validator.iku-lldikti.index') }}" class="{{ $sublinkBase }} {{ request()->routeIs('validator.iku-lldikti.*') ? $sublinkActive : $sublinkIdle }}">IKU LLDIKTI</a>
        <a href="{{ route('validator.rencana-aksi.index') }}" class="{{ $sublinkBase }} {{ request()->routeIs('validator.rencana-aksi.*') ? $sublinkActive : $sublinkIdle }}">Rencana Aksi Triwulan</a>
    </div>
</div>
