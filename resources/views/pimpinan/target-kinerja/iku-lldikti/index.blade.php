...
@section('title', 'Target & Capaian Kinerja')
@section('subtitle', 'Tampilan baca-saja, lintas seluruh Tim Kerja, dapat berpindah Triwulan')
            ...
            <table class="w-full text-left text-sm">
                <thead>
                    <tr class="bg-ink-900 text-white">
                        ...
                        <th rowspan="2" class="w-32 px-4 py-3 text-center align-middle font-semibold">Tim Kerja</th>
                        ...
                        @forelse ($sasaran->iku as $iku)
                            ...
                            <tr class="hover:bg-brand-50/40">
                               @if ($loop->first)
                                ...
                                <td class="px-4 py-3 text-center text-slate-600">{{ $iku->timKerja->pluck('nama_tim')->join(', ') ?: '—' }}</td>
