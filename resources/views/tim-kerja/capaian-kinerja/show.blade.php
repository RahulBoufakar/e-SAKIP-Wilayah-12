...
@section('content')
    ...
    <div class="mt-4 rounded-2xl bg-white p-6 shadow-card">
        ...
        @else
            @error('realisasi')
                <div class="mb-4 flex items-start gap-3 rounded-2xl border border-rose-200 bg-rose-50 px-5 py-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0 text-rose-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
